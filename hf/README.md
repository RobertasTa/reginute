...
> here, including the ones in `samples/`, is generated by AI and not recorded
> by a person. If you publish audio made with this voice, check whether it
> needs an AI disclosure label (EU AI Act, Article 50, applicable since
> 2 August 2026).
